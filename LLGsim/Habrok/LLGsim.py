...
class LLGsim:
    ...
    def animate_m_vector(self):
        ...
        ani = FuncAnimation(
            ...
            frames=range(0, len(self.m_steps), self.frames),  # every 100th frame
    ...
    def plot_m_vector(self):
        ...
        ax.set_title(f'LLG Magnetization Precession, dt = {self.dt}, every {self.frames} frames')
...
if __name__ == "__main__":
	LLG = LLGsim(Hext=np.array([1, -1, 0]), m0 = np.array([1, -1, 0.0]), H_drive_amp=0.01, sigma=np.array([1, 1, 0]))
